...
def duplicating_files_in_current_directory(directory):
    ...
    while answer != 'Q' and answer != 'N' and answer != 'q' and answer != 'n':
        ...
        if answer == 'Y' or answer == 'y':
            ...
            if todo == 1:
                ...
                duplicating_files_in_current_directory('.')
            elif todo == 5:
                ...
                fullname_of_file_to_duplicate = os.path.join(specific_directory,
                                                             file_to_duplicate)  # function to join full path to the file with the name of the file
                ...
                i = 0
                while i < len(file_list):
                    file_deleting(os.path.join(specific_directory, file_list[i]))
                    i += 1
                print(i, " files were checked now!")
            else:
                pass  # for the empty construction
...
# Checking if current program is running and after that run the function 'main'
